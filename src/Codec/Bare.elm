module Codec.Bare exposing
    ...
    , map, andThen
    , lazy, recursive
    , char, constant, customWithIdCodec, float32, float64, result, signedInt, signedInt16, signedInt32, signedInt8, triple, tuple, unsignedInt, unsignedInt16, unsignedInt32, unsignedInt8
    )
...
import Codec.Bytes as CB
import Codec.Internal as Internal exposing (Codec(..), build)
